    ...
    <div class="signinpanel">
        <div class="row">
            <div class="col-sm-7">
                <div class="signin-info">
                    ...
                    <strong>还没有账号？ <a href="${request.contextPath}/jsp/register.jsp">立即注册&raquo;</a></strong>
                </div>
            </div>
           <div class="col-sm-5">
                <form method="post" action="${pageContext.request.contextPath}/login/login.do">
                    ...
                    <input type="text" id="tips" class="form-control uname" name="userName" placeholder="用户名" />
     ...
     <script src="${pageContext.request.contextPath}/js/jquery.min.js?v=2.1.4"></script>
      <script src="${pageContext.request.contextPath}/js/plugins/layer/layer.min.js"></script>
       ...
       $(function(){
           layer.tips('臭傻逼', '#tips', {area: 'auto',maxWidth: '300',time: 4000});
       })
